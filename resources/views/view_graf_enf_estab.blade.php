...
<script>
  $('input:radio[name=Ambito]').click(function() {
    ...
    var sx=$("input[name='Sexo']:checked").val();
      ...
      $.getJSON("act_graf_enf_estab/"+sx+"/"+edv+"/"+amv+"/"+mrv+"/"+esv,function(data){
        graf_enf_estab(data);
        switch(amv)
        {
            case 'R':
...
<script>
    function graf_enf_estab(datos) {
        ...
        var chartData = [];
                ...
                {
                    chartData.push({"enfermedad":n['enfermedad'],
                    "total":n['total'],
                ...
                if(RESTO>0)
                {
                    ...
                    chartData.push({"enfermedad":"Otros",
                    "total":RESTO,
                ...
                chart.categoryField = "enfermedad";
                chart.theme="light";
