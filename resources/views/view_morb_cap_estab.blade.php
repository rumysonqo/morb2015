...
<center><h2>Morbilidad General por Capitulos CIE-10 Red Cusco Norte 2015</h3></center>
...
$("#edad").change(function(event){
  ...
  $.getJSON("act_morb_cap_estab/"+sx+"/"+event.target.value+"/"+mcr+"/"+esv,function(data){
    var linea="<tbody>";
    $.each(data, function(){
      linea+="<tr>";
    ...
    $('h2').text("Morbilidad 2015 por Capitulos CIE-10 "+"Micro Red "+nommic);
...
$("#micro").change(function(event){
  ...
  $.getJSON("act_morb_cap_estab/"+sx+"/"+edv+"/"+mcr+"/"+esv,function(data){
    var linea="<tbody>";
    $.each(data, function(){
      linea+="<tr>";
      linea+="<td>"+this.capitulo+"</td>";
