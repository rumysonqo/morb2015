...
$("#edad").change(function(event){
  ...
  $.getJSON("act_morb_enf_micro/"+sx+"/"+event.target.value+"/"+mcr,function(data){
    var linea="<tbody>";
    $.each(data, function(){
      linea+="<tr>";
...
$("#micro").change(function(event){
  ...
  $.getJSON("act_morb_enf_micro/"+sx+"/"+edv+"/"+mcr,function(data){
    var linea="<tbody>";
    $.each(data, function(){
      linea+="<tr>";
      linea+="<td>"+this.enfermedad+"</td>";
    ...
    $('h2').text("Morbilidad 2015 por Enfermedades CIE-10");
