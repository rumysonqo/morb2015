...
$("#edad").change(function(event){
  ...
  $.getJSON("act_morb_cap_micro/"+sx+"/"+event.target.value+"/"+mcr,function(data){
    var linea="<tbody>";
    $.each(data, function(){
      linea+="<tr>";
    ...
    $('h2').text("Morbilidad 2015 por Capitulos CIE-10");
...
$("#micro").change(function(event){
  ...
  $.getJSON("act_morb_cap_micro/"+sx+"/"+edv+"/"+mcr,function(data){
    var linea="<tbody>";
    $.each(data, function(){
      linea+="<tr>";
      linea+="<td>"+this.capitulo+"</td>";
