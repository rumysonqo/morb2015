...
<center><h3>Morbilidad General por Categorias CIE-10 Red Cusco Norte 2015</h3></center>
...
$("#edad").change(function(event){
  ...
  $.getJSON("act_morb_cat/"+sx+"/"+event.target.value,function(data){
    var linea="<tbody>";
    $.each(data, function(){
      linea+="<tr>";
    ...
    $('h3').text("Morbilidad por Categorias CIE-10 Año: 2015 Sexo: "+sex+" - Grupo de Edad: "+grp);
